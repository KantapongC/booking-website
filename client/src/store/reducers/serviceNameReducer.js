import {
  CREATE_SERVICE_NAME_SUCCESS,
  CREATE_SERVICE_NAME_ERROR,
  UPDATE_SERVICE_NAME_SUCCESS,
  UPDATE_SERVICE_NAME_ERROR,
  DELETE_SERVICE_NAME_SUCCESS,
  DELETE_SERVICE_NAME_ERROR
} from '../actions/serviceNameActions';
