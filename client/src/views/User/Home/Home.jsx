      ...
      <Carousel autoplay autoplaySpeed={4000}>
        ...
        <div>
          ...
          <div className='content'>
            ...
            <div className='text'>corrupti architecto quas quo repudiandae natus cumque nostrum sunt inventore commodi</div>
          </div>
        </div>
        <div>
          ...
          <div className='content'>
            ...
            <div className='text'>illum quasi cumque maxime ullam assumenda alias, quae, recusandae consequuntur a natus. Quasi repudiandae magni reiciendis</div>
          </div>
        </div>
      </Carousel>
    );
